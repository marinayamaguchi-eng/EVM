...
const ACCESS_TOKEN = process.env.SMARTSHEET_TOKEN;
...
async function transposeDates() {    
    ...
    */
    ...
    //実績列に関数を設定
    const sumFormula =
     `=IF([行階層]@row = 0, 0, SUM([${refreshedDateCols[0].title}]@row:[${refreshedDateCols[refreshedDateCols.length - 1].title}]@row))`;
